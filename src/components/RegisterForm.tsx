'use client'
import { ArrowLeft, EyeIcon, EyeOff, Loader2, Lock, LogIn, Mail, User, Wrench } from 'lucide-react'
...
function RegisterForm({ previousStep }: propType) {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
      <div className='absolute top-6 left-6 flex items-center gap-2 text-red-700 hover:text-red-800 transition-colors cursor-pointer' onClick={() => previousStep(1)}>
      ...
      <p className='text-gray-600 mb-8 flex items-center gap-1'>
        Join AutoPartsHub today<Wrench className='w-5 h-5 text-red-600' />
      </p>
